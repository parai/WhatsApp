...
void VirtualCan::on_play_pause(void)
{
...
void VirtualCan::on_clear_trace(void)
{
    QStringList  list;
    tableTrace->clear();
...
void VirtualCan::on_save_trace(void)
{
    quint32 prevTime;
...
void VirtualCan::on_load_trace(void)
{
...
void VirtualCan::on_hexl_decimal(void)
{
...
void VirtualCan::on_abs_rel_time(void)
{
...
void VirtualCan::putMsg(OcMessage*msg)
{
...
void VirtualCan::timerEvent(QTimerEvent *Event)
{
...
void VirtualCan::on_trigger_tx(void)
{
    bool ok;
...
OcMessage* VirtualCan::entry2msg(QRegularExpressionMatch match)
{
    OcMessage* msg = NULL;
